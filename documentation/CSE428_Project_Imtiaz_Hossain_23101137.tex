...
\begin{tabular}{lccc}
\toprule
\textbf{Model} & \textbf{Val Dice} & \textbf{Epochs} & \textbf{Time (h)} \\
\midrule
U-Net & \textbf{83.10\%} & 100 & 7.0 \\
Attention U-Net & 82.29\% & 100 & 7.5 \\
\bottomrule
\end{tabular}
...
Key findings:
\begin{itemize}
    \item Vanilla U-Net achieved best performance (83.10\% Dice)
    \item Attention U-Net slightly underperformed (-0.81\%)
    \item All models showed excellent convergence
...
\begin{enumerate}
    \item Use \textbf{U-Net} for segmentation (83.10\% Dice)
...
\begin{itemize}
    ...
    \item Best segmentation: U-Net (83.10\% Dice)
    \item Most efficient segmentation: BiFPN (81.30\% Dice, 38\% fewer parameters)
    ...
    \item Completed all 4 bonus tasks with comprehensive analysis
